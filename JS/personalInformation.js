...
let add_F1skill = document.querySelector(".HiddenInput51").value.split(",");
let numberF1Kill;
...
let add_F2skill = document.querySelector(".HiddenInput52").value.split(",");
let numberF2Kill;
...
let add_F3skill = document.querySelector(".HiddenInput53").value.split(",");
let numberF3Kill;
