  ...
  <header>
    <div class="profile-page sidebar-collapse">
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
        <div class="container">
          <div class="navbar-translate"><a class="navbar-brand" href="../../PHP/home.PHP" rel="tooltip">Business City</a>
          ...
          <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="container">
              <div class="content-center">
                <div class="cc-profile-image"><a><img src="../<?php echo $img_path; ?>" alt="Image" /></a></div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-12">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-4"><strong class="">Age:</strong></div>
                    <div class="col-sm-8"><?php echo $birth_date; ?></div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="">Email:</strong></div>
                    <div class="col-sm-8"><?php echo $user_email; ?></div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="">Phone:</strong></div>
                    <div class="col-sm-8"><?php echo $phone_number; ?></div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="">Address:</strong></div>
                    <div class="col-sm-8"><?php echo $city; ?></div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="">Language:</strong></div>
