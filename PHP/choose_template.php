...
<body>
   ...
   <div class="chooseTbox">
      <div data-aos="fade-up" data-aos-anchor-placement="top-center" class="templateBox">
         ...
         <div class="showT">
            <p onclick="window.location.href='../TempletCV/T2/CV1.PHP'">عرض النموذج</p>
         </div>
      </div>
      <div data-aos="fade-up" data-aos-anchor-placement="top-center" class="templateBox">
         ...
         <div class="showT">
            <p onclick="window.location.href='../TempletCV/T1/CV2.php'">عرض النموذج</p>
         </div>
      </div>
      <div data-aos="fade-up" data-aos-anchor-placement="top-center" class="templateBox">
         ...
         <div class="showT">
            <p onclick="window.location.href='../TempletCV/T3/CV3.php'">عرض النموذج</p>
         </div>
      </div>
   </div>
